...
class User(db.Model, UserMixin):
    ...
    notification_type = db.Column(db.String(16), default='none')  # none/wechat/telegram
    webhook_url = db.Column(db.String(512))  # Webhook URL
...
class ReservationHistory(db.Model):
    ...
    status = db.Column(db.String(16))  # 成功/失败/auth_failed
...
class Traffic(db.Model):
    ...
    count = db.Column(db.Integer, nullable=False)  # 在馆人数
    created_at = db.Column(db.DateTime, default=datetime.now)
